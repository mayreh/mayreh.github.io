;(function () {
  ...
  var eternalTriangleAnimate = function() {
    if ( $('#fh5co-eternal-triangle').length > 0 ) {

      $('#fh5co-eternal-triangle').waypoint( function( direction ) {

        if( direction === 'down' && !$(this.element).hasClass('animated') ) {


          setTimeout(function() {
            $('#fh5co-eternal-triangle .to-animate').each(function( k ) {
              var el = $(this);
